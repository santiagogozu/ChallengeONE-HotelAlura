...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		// super("Reserva");
		// Instanciando la clase RservasController
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				 ...
				 * new RegistroHuesped(); registro.setVisible(true); } else {
	...
	protected void calcularValor(JDateChooser txtFechaEntrada, JDateChooser txtFechaSalida) {
		...
		try {
			d1 = (Date) txtFechaEntrada.getDate();
			d2 = (Date) txtFechaSalida.getDate();
		} catch (Exception e) {
		...
		if (d2 != null) {
			...
			long cost = days * 90000;
			String txtCost = Long.toString(cost);
			txtValor.setText(txtCost);
